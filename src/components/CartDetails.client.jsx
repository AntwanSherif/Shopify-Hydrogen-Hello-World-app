...
export function CartDetails({ onClose }) {
  ...
  return (
    <form className='grid grid-cols-1 grid-rows-[1fr_auto] h-[calc(100vh-6rem)]'>
      <section aria-labelledby='cart-contents' className='px-4 pb-4 overflow-auto transition md:px-12'>
      ...
      <section aria-labelledby='summary-heading' className='p-4 border-t md:px-12'>
...
export function CartEmpty({ onClose }) {
  return (
    <div className='flex flex-col space-y-7 justify-center items-center md:py-8 md:px-12 px-4 py-6 h-screen'>
      <h2 className='whitespace-pre-wrap max-w-prose font-bold text-4xl'>Your cart is empty</h2>
      <button
        onClick={onClose}
        ...
        <div className='relative grid gap-1'>
          ...
          <div className='flex items-center gap-2 mt-auto'>
            <div className='flex justify-start text-copy mr-4'>
              <CartLineQuantityAdjust lineId={lineId} quantity={quantity} linesRemove={linesRemove} />
            </div>
            <button
              type='button'
            ...
            >
              ...
              <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20' className='w-[13px] h-[14px]'>
                <title>Remove</title>
                <path
